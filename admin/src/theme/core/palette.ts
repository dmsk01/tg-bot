...
// Cosmic Flow backgrounds
export const background = {
  light: createPaletteChannel({ paper: '#FFFFFF', default: '#FAFAFF', neutral: '#F4F4F9' }),
  dark: createPaletteChannel({ paper: '#13102B', default: '#0C0A1D', neutral: '#1A1635' }),
};
